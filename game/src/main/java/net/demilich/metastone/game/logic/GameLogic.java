...
import net.demilich.metastone.game.behaviour.IDNuevoEsbirro;
...
public class GameLogic implements Cloneable {
	...
	private void assignCardIds(CardCollection cardCollection) {
		for (Card card : cardCollection) {
			...
			//imprime por consola la carta y su id
			System.out.println("Carta: "+card.getName()+" ID: "+card.getId());
		}
	}
	...
	public void init(int playerId, boolean begins) {
		...
		AccionesTurnoMedia.vaciarSeguimientoEsbirros();
		AccionesTurnoMejorValor.vaciarSeguimientoEsbirros();
		player.getHero().getHeroPower().setId(idFactory.generateId());
		assignCardIds(player.getDeck());
		assignCardIds(player.getHand());

		//imprime por consola el nombre del heroe, su identificador, su poder de heroe y el identificador de su poder de heroe
		System.out.println("Heroe: " + player.getHero().getName() + " ID: " + player.getHero().getId() + " Poder de heroe: " + player.getHero().getHeroPower().getName() + " ID: " + player.getHero().getHeroPower().getId());
	...
	public void startTurn(int playerId) {
		Player player = context.getPlayer(playerId);
		//System.out.println("-------------------------------------Start turn: "+ playerId);
	...
	public boolean summon(int playerId, Summon summon, Card source, int index, boolean resolveBattlecry) {
		...
		int helper = summon.getId();
		// cada vez que se llame a esta funcion se suma uno al contador de ids de las cartas
		IDNuevoEsbirro.setIdNuevoEsbirro(helper);
